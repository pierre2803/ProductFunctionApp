...
abstract class ConfigurationFunction {
    ...
    protected fun toNoContentResponse(request: HttpRequestMessage<*>): HttpResponseMessage {
    ...
    private fun toErrorResponse(errors: List<com.pierre2803.functionapp.ApplicationError>, request: HttpRequestMessage<*>): HttpResponseMessage {
    ...
    private fun toErrorResponse(httpStatusCode: Int, errorJsonPayload: String, request: HttpRequestMessage<*>): HttpResponseMessage {
        return request.createResponseBuilder(HttpStatus.valueOf(httpStatusCode))
                .header("Content-Type", "application/json")
                .body(errorJsonPayload)
                .build()
    }
